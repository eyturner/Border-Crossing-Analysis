...
4. For each item in the dictionary, add two new items to their corresponding list:
  1. A running average (needed for output file later)
  2. A counter for how many times we've seen this kind of border crossing at this border previously, (needed for updating running average)
1. Get rid of the counter for each border crossing datum
1. Output our results to the output CSV!
